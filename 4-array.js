...
for (const name in metadata) {
	buildGetter(PersonArr.prototype, name, metadata[name], index++);
}
...
Object.keys(data1).forEach(person =>
	Object.setPrototypeOf(data1[person], PersonObj.prototype));

data2.forEach(person => Object.setPrototypeOf(person, PersonArr.prototype));
